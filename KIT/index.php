                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" role="search">
                        ...
                        <datalist id="brow">
                            ...
                            <option value="Гончарук">
                            <option value="Усенко">
                            <option value="Вдівець">
                            <option value="Жмишенко">
                            <option value="Шмаль">
                            <option value="Маляр">
                        </datalist>
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="src/pexels-mike-1192043 (1).jpg.jpg" class="d-block w-100" alt="...">
        ...
        <section class="treners">
            ...
            <div class="card" id="Моставчук" style="width: 12rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Тридцять сім років професіоналізму</p>
                </div>
            </div>

            <div class="card" id="Гончарук" style="width: 12rem;">
                <img src="src/julia.jpg" class="card-img-top human" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Каріна Гончарук</h5>
                    <p class="card-text">Допоможу досягти автоматизму в рухах</p>
                </div>
            </div>
            ...
            <div class="card" id="Вдівець" style="width: 12rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Баскетбольна площадка - моє все</p>
                </div>
            </div>
            
            <div class="card" id="Жмишенко" style="width: 12rem;">
                <img src="src/pexels-pavel-danilyuk-6203689.jpg" class="card-img-top human" alt="...">
                <div class="card-body">
                    <h5 class="card-title">Валерій Жмишенко</h5>
                    <p class="card-text">Гандбол потрібно грати не руками, а головою</p>
                </div>
            </div>
            ...
            <div class="card" id="Шмаль" style="width: 12rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Майстер спорту з плавання</p>
                </div>
            </div>
            ...
            <div class="card" id="Маляр" style="width: 12rem;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">В карате немає першої атаки</p>
                </div>
            </div>
        </section>
